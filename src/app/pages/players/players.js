...
function sortTable(elInd) {
    ...
    while (switching) {
      ...
      for (i = 1; i < (rows.length - 1); i++) {
        ...
        if(x.innerHTML.match(myRe2)!==null){
            strgx += x.innerHTML.match(myRe2);  
            console.log(strgx);
            console.log("3%".match(myRe2));
        }
        else{       
            strgx += x.innerHTML.match(myRe3); 

            console.log(" 3%".match(myRe2));
        }

        if(y.innerHTML.match(myRe2)!==null){
            strgy += y.innerHTML.match(myRe2);         
        }
        else{
            strgy += y.innerHTML.match(myRe3);
        }
