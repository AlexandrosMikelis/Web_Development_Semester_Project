...
// app.get('/', (req, res) => {
//     res.render('signed-manager', { loggedin: true, partialContext: {name: "John"}})
//   });

// app.get('/', (req, res) => {
//       res.render('time-selection',{style: ["signed-manager-main","time-selection"]})
//     });

// app.get('/', (req, res) => {
//   res.render('team-layout-management', { loggedin: false, disabled:false,teamname:"My Team" ,
//     style: ["signed-manager-main","team-layout-management","alert"]})
// });
// app.get('/submit-status', (req, res) => {
//   res.render('team-layout-management', { loggedin: false, disabled:true,teamname:"My Team" ,
//     style: ["signed-manager-main","team-layout-management","alert"]})
// });

// app.get('/afterregister', (req, res) => {
//   res.render('index',{aftersignup:true, style:["signed-manager-main","alert2"]})
//   });
