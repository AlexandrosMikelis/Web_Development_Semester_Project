...
const teams = [
  {
    "id":1,
    "TeamName" : "Achaias Rangers",
    "TeamLogo" : "/images/team-logos/barcelona.png",
    "TeamPlayers": [
      {
        "player_id":1,
        "playerName":"Πέτρος Παπαχρήστου",
      ...
      {
        "player_id":2,
        "playerName":"Γιάννης Χριστόλογλου",
      ...
      {
        "player_id":6,
        "playerName":"Γιάννης Καραγιάννης",
  ...
  },
  {
    ...
    "TeamPlayers": [
      ...
      {
        "player_id":2,
        "playerName":"Γιαννης Χριστόλογλου",
        "photo": "/images/players/00008.jpg",
        "goals":0,
        "assists":3,
        "isTopPlayer":false,
        "position":"Αμυντικός",
      ...
      },
      {
        "player_id":4,
        "playerName":"Μάριος Μπαλάσκας",
        "photo": "/images/players/00010.jpg",
        "goals":0,
        "isTopPlayer":false,
        "assists":3,
        "position":"Αμυντικός",
      ...
      },
      {
        "player_id":5,
        "playerName":"Σταμάτης Λογοθέτης",
        "photo": "/images/players/00011.jpg",
        "goals":4,
        "isTopPlayer":true,
        "assists":3,
        "position":"Επιθετικός",
      ...
      },
      {
        "player_id":6,
        "playerName":"Γιάννης Καραγιάννης",
        "photo": "/images/players/00009.jpg",
        "goals":0,
        "isTopPlayer":false,
        "assists":3,
        "position":"Επιθετικός",
      ...
      },
      {
        "player_id":1,
        "playerName":"Πέτρος Παπαχρήστου",
        "photo": "/images/players/00007.jpg",
        "goals":0,
        "isTopPlayer":false,
        "assists":3,
        "position":"Αμυντικός",
...
router.get('/players',  (req, res) => {
  res.render('players',{aftersignup:false,loggedin :false,notadmin:true, team:teams, style:["_globals","modal","navbar","footer","loginstyle","index",'players']})
});
...
router.get('/registration-page', (req, res) => res.render('registration-page',{ notadmin:true, style:["_globals","modal","navbar","footer","loginstyle","index","registration-page"]}))
